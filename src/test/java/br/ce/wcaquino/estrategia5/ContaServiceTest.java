...
public class ContaServiceTest {
	...
	public static void inserirConta() throws Exception {
		...
		conn.createStatement().executeUpdate(
				"INSERT INTO usuarios (id, nome, email, senha) VALUES (1, 'Usuario de controle', 'usuario@email.com', 'passwd')");
		conn.createStatement()
				.executeUpdate("INSERT INTO contas (id, nome, usuario_id) VALUES (1, 'Conta para testes', 1)");
		conn.createStatement()
				.executeUpdate("INSERT INTO contas (id, nome, usuario_id) VALUES (2, 'Conta CT005 para alteracao', 1)");
		conn.createStatement()
				.executeUpdate("INSERT INTO contas (id, nome, usuario_id) VALUES (3, 'Conta para deletar', 1)");
	}
